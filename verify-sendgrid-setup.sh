...
echo "✅ After Verification, Test Here:"
echo "---------------------------------------------------"
...
echo "🔍 How to Check if Sender is Verified:"
echo "---------------------------------------------------"
echo "1. Go to: https://app.sendgrid.com/settings/sender_auth/senders"
echo "2. Look for: $EXPECTED_EMAIL_FROM"
echo "3. Status should show: 'Verified' with green checkmark ✅"
echo "4. If status is 'Pending' → Check Gmail for verification email"
echo "5. If not listed → Create new sender and verify"
echo ""

echo "📊 SendGrid Activity Feed:"
echo "---------------------------------------------------"
echo "URL: https://app.sendgrid.com/activity"
echo ""
echo "Look for these statuses:"
echo "  ✅ Processed - Email accepted by SendGrid"
echo "  ✅ Delivered - Email delivered to recipient"
echo "  ❌ Dropped - Usually means sender not verified"
echo "  ❌ Bounced - Recipient email invalid"
echo ""
