        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg mb-6">
          <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
            <div className="flex flex-wrap gap-3 items-end">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">{t('admin.trucksAdmin.statusLabel')}</label>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                      <Truck className="h-10 w-10 text-gray-400 dark:text-gray-400 dark:text-gray-400 dark:text-gray-500" />
                    </div>
                    <div className="ml-4">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">{truck.make} {truck.model} {truck.year} • {truck.truck_type}</p>
                      {truck.provider_company && (
                        <p className="text-xs text-gray-500 dark:text-gray-400">Provider: {truck.provider_company}</p>
                      )}
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
