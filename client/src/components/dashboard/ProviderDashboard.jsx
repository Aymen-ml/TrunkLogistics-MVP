...
const ProviderDashboard = () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'inactive': return 'bg-gray-100 dark:bg-gray-700 text-gray-800';
      case 'rented': return 'bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200';
          ...
          <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                ...
                <Link
                  to="/trucks"
                  className="text-sm text-accent-500 hover:text-accent-600 transition-colors font-medium whitespace-nowrap"
                >
