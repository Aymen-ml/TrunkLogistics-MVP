          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4">
                  <h3 className="text-base sm:text-lg font-medium text-gray-900">Find Equipment</h3>
                  <p className="text-xs sm:text-sm text-gray-500">Monthly equipment rentals</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4">
                  <h3 className="text-base sm:text-lg font-medium text-gray-900">Find Trucks</h3>
                  <p className="text-xs sm:text-sm text-gray-500">Search available trucks</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4">
                  <h3 className="text-base sm:text-lg font-medium text-gray-900">New Booking</h3>
                  <p className="text-xs sm:text-sm text-gray-500">Create a new shipment</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4">
                  <h3 className="text-base sm:text-lg font-medium text-gray-900">My Bookings</h3>
          ...
          <div className="divide-y divide-gray-200">
            {recentBookings.length === 0 ? (
              ...
              recentBookings.map((booking) => (
                <Link key={booking.id} to={`/bookings/${booking.id}`} className="block hover:bg-gray-50 transition-colors">
