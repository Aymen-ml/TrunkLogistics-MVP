      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">
            {error?.isAuthError ? t('trucks.accessDenied') : error ? t('trucks.errorLoading') : t('trucks.notFound')}
          </h2>
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            {error ? error.message : t('trucks.notFoundDesc')}
          </p>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-yellow-800 dark:text-yellow-200">
                    {t('trucks.emailVerificationRequired')}
                  </h3>
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>{t('trucks.emailVerificationDesc')}</p>
                    <p className="mt-1">{t('trucks.checkInbox')}</p>
                  </div>
                  <div className="mt-3">
                    <Link
                      to="/profile"
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-blue-800 dark:text-blue-200">
                    {t('trucks.providerAccessRestriction')}
                  </h3>
                  <div className="mt-2 text-sm text-primary-700">
                    <p>{t('trucks.providerAccessDesc')}</p>
                    <p className="mt-1">{t('trucks.providerAccessDesc2')}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {error && !error.isAuthError && (
            <div className="mt-4 p-3 bg-gray-100 dark:bg-gray-700 rounded-md text-left">
              <p className="text-xs text-gray-600 dark:text-gray-400">Debug Info:</p>
        ...
        <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">{t('trucks.truckInfo')}</h3>
              <div className="flex items-center">
          ...
          <div className="mt-8 bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">{t('trucks.truckImages')}</h3>
          ...
          <div className="mt-8 bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">{t('trucks.documents')}</h3>
                    ...
                    <div key={index} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center flex-1 min-w-0">
                          <div className="flex-shrink-0">
                            <FileText className="h-10 w-10 text-gray-400 dark:text-gray-400 dark:text-gray-400 dark:text-gray-500" />
                          </div>
                            ...
                            onClick={async () => {
                              try {
                                ...
                                if (!newWindow) {
                                  ...
                                  const fileName = getDocumentTitle(doc.file_name, doc.document_type);
