...
import { validateUUID, validateRequest } from '../middleware/validation.js';
...
router.get('/:id/info', validateUUID, validateRequest, getDocumentInfo);
router.get('/:id/download', validateUUID, validateRequest, downloadDocument);
